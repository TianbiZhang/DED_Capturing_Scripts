...
b_initialize_mpx2 = Button(root, text="Init. MPX2 Dev.", font=("Arial", 10), command=DEDInitializeMPX2, bg='teal',
                           fg='white', activebackground="lightblue", padx=10, pady=10)
b_initialize_mpx2.grid(column=0, row=0, sticky=W, padx=5, pady=5)
b_initialize_mpx2["state"] = "disabled"

b_initialize_tpx3 = Button(root, text="Init. TPX3 Dev.", font=("Arial", 10), command=DEDInitializeTPX3, bg='teal',
                           fg='white', activebackground="lightblue", padx=10, pady=10)
...
b_browse = Button(root, text="Browse...", font=("Arial", 10), command=browse_button, bg='teal', fg='white',
...
b_readtemp = Button(root, text="Read Temp. (TPX3 only!)", font=("Arial", 10), command=UpdateTemp, bg='teal', fg='white',
                    activebackground="lightblue", padx=10, pady=10)
...
b_exitded = Button(root, text="Close PIXET API", font=("Arial", 10), command=DEDExit, bg='teal', fg='white',
                   activebackground="lightblue", padx=10, pady=10)
b_exitded.grid(column=0, row=3, sticky=W, padx=5, pady=5)

# Button for close API
b_exitded = Button(root, text="Generate Log File", font=("Arial", 10), command=WriteLogFile, bg='teal', fg='white',
                   activebackground="lightblue", padx=10, pady=10)
b_exitded.grid(column=1, row=3, sticky=W, padx=5, pady=5)

# Button for closing the window
exit_button = Button(root, text="Exit Program", font=("Arial", 10), command=root.destroy, bg='teal', fg='white',
                     activebackground="lightblue", padx=10, pady=10)
exit_button.grid(column=2, row=3, sticky=W, padx=1, pady=5)

labelExitNotice = Label(root, text='Please close DED controls first before closing the window.', font=("Arial", 10),
...
labelCopyinfo = Label(root, text='This widget is developed by Tianbi Zhang, October 2022. All rights reserved.',
                      width=80)
